<?php
    ...
    $mail->SMTPAuth = true;
    $mail->CharSet = 'UTF-8'; 
    $mail->Username = 'wjddmswl3712';
    $mail->Password = 'j65023!';
    $mail->setFrom('wjddmswl3712@naver.com', 'PHP Class');      //중계 역할
    $mail->addReplyTo($contactFrom, '안녕하세요!');             //보내는 사람
    $mail->addAddress('wjddmswl3712@gmail.com', 'John Doe');    //받는 사람
