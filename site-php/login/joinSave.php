...
<?php
	...
	// var_dump(filter_var('billie@naver.com', FILTER_VALIDATE_EMAIL));
	...
	if( $check_name == false ){
		msg("이름이 정확하지 않습니다. <br> 다시 한번 확인해주세요!");
		exit;
	}
	...
	//데이터 가져오기 -> 유효성 검사 -> 중복검사(이메일, 핸드폰) -> 회원가입
	//회원가입
